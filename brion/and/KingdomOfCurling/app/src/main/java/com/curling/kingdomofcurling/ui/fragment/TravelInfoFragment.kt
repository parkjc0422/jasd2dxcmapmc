...
class TravelInfoFragment : Fragment() {
    enum class PageStep {
        Normal, Coupon, Travel
    }

    lateinit var travelInfoAdapter: TravelInfoAdapter

    var currentStep:PageStep = PageStep.Normal
    ...
    fun initParent () {
        ...
        if(currentStep == PageStep.Travel) {
...
//TODO : remake after server connection
    ...
    companion object {
        ...
        fun newInstance ():TravelInfoFragment {
            var newInstance = TravelInfoFragment()
            newInstance.currentStep = PageStep.Normal
            return newInstance
        }
    }
